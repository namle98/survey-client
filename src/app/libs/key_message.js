export const getMessageKey = (package_id, license_key) => {
    ...
    return `Chào Quý khách, \nCảm ơn Quý khách đã đặt mua tài khoản ${packageName} của ứng dụng Survey – Học tiếng anh với ngôn ngữ NLP.\nĐây là MÃ KEY đặt hàng của Quý khách: ${license_key}\nĐể Kích hoạt mã sử dụng, Quý khách vui lòng theo hướng dẫn sau:\nBước 1: Tải App Survey trên kho ứng dụng Android hoặc iOS\nBước 2: Đăng ký thành viên của Survey APP\nBước 3: Truy cập vào đường link sau để Kích hoạt: https://Survey.net/redeem (Yêu cầu đăng nhập thông tin thành viên trên APP)\nBước 4: Mở APP và đăng nhập lại. Sẵn sàng sử dụng theo thời hạn đặt mua.\n\nVì sự thành công của bạn,\nSurvey Team`
}